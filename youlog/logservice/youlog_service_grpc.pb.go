...
type LogServiceClient interface {
	WriteLog(ctx context.Context, in *LogData, opts ...grpc.CallOption) (*WriteReply, error)
}
...
type LogServiceServer interface {
	WriteLog(context.Context, *LogData) (*WriteReply, error)
...
func (UnimplementedLogServiceServer) WriteLog(context.Context, *LogData) (*WriteReply, error) {
